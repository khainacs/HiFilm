                ...
                <div className="container px-4 mx-auto">
                    <div className="flex flex-col-reverse items-center md:flex-row md:items-start md:space-x-8">
                        <div className="w-full mt-8 md:mt-0 md:w-1/2 text-center md:text-left">
                            <h2 className="text-title-400 font-bold md:text-2xl mb-2">
                                {movieData.title}
                            </h2>
                            <h1 className="mb-4 text-2xl font-bold leading-tight text-title-600 md:text-4xl lg:text-5xl">
                                {movieData.subtitle}
                            </h1>
                            <div className="flex flex-wrap justify-center md:justify-start items-center mb-4 space-x-2 space-y-2 md:space-y-0">
                                <span className="bg-wine-red-700 text-white text-[12px] font-semibold px-3 py-1 rounded">
                                    PG 18
                                </span>
                                <span className="bg-wine-red-700 text-white text-[12px] font-semibold px-3 py-1 rounded">
                                    HD
                            ...
                            <div className="mt-6">
                                <button
                                    className="before:ease rounded-lg relative h-12 w-full md:w-48 overflow-hidden bg-blue-700 text-slate-300 shadow-2xl 
                  transition-all before:absolute before:top-1/2 before:h-0 before:w-64 before:origin-center before:-translate-x-20
                  before:rotate-45 before:bg-title-800 before:duration-300 hover:text-white hover:font-bold hover:shadow-title-400 hover:before:h-64
