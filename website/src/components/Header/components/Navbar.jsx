...
export default function Navbar() {
    ...
    return (
        <nav id="header" className="fixed top-0 z-30 w-full bg-transparent">
            <div className="h-[60px] bg-[#252631] grid grid-cols-2 shadow-lg items-center justify-between px-4 md:px-8 mx-auto">
                ...
                {/* Mid (Logo and Nav Links) */}
                <div className="flex items-center justify-between space-x-8 text-white col-span-1">
                ...
                <div className="hidden md:flex items-center space-x-4 ml-8 justify-start">
                    ...
                    <button 
                        ...
                        className="text-gray-300 hover:text-white focus:outline-none font-medium text-sm px-2 py-1 text-center inline-flex items-center" 
                        type="button">
